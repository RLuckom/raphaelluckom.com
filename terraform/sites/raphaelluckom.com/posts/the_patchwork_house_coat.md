...
meta:
  trail:
    ...
    - sewing
---
![foo](/img/housecoat/coat-back.jpeg "Back view of coat")
![foo](/img/housecoat/coat-front.jpeg "Front view of coat")
...
![T-shirts attached at the hem](/img/housecoat/lining-core.jpeg "T-shirts attached at the hem")
...
![Extending the width. Note the rotated dark green shirt at the bottom — it adds an extra half-shirt of length to the column in the center, so that the shirts on the sides are shifted and fill in the gaps in the edges of the shirts in the center.](/img/housecoat/shirt-panel-01.jpeg "Extending the width. Note the rotated dark green shirt at the bottom — it adds an extra half-shirt of length to the column in the center, so that the shirts on the sides are shifted and fill in the gaps in the edges of the shirts in the center.")
...
![Approximately rectangular piece with straight sides made of four T-shirt columns](/img/housecoat/shirt-panel-02.jpeg "Approximately rectangular piece with straight sides made of four T-shirt columns")
...
![Small scale mock-up](/img/housecoat/small-scale.jpeg "Small scale mock-up")
...
![Golden ratio panel](/img/housecoat/golden-ratio.jpeg "Golden ratio panel")
...
![Layout for the coat back and arms. The darker pieces in the middle are backed with white dress shirt material.](/img/housecoat/housecoat-layout-01.jpeg "Layout for the coat back and arms. The darker pieces in the middle are backed with white dress shirt material.")
...
![Stages of layout and construction](/img/housecoat/housecoat-layout-04.jpeg "Stages of layout and construction")
...
![Shell layer laid out over the liner layer. Corners cut out of the liner layer to match the shape of the shell. I ended up using the off cuts from this stage to build a little more length into the front bottom where you can see that the shell goes beyond the liner.](/img/housecoat/housecoat-layout-05.jpeg "Shell layer laid out over the liner layer. Corners cut out of the liner layer to match the shape of the shell. I ended up using the off cuts from this stage to build a little more length into the front bottom where you can see that the shell goes beyond the liner.")
...
![I rolled the sewing machine cart back along the edge of the table as I stitched up the seam between the liner and the shell. I’m pretty proud of that solution.](/img/housecoat/sewing-01.jpeg "I rolled the sewing machine cart back along the edge of the table as I stitched up the seam between the liner and the shell. I’m pretty proud of that solution.")

I then cut off all the excess liner fabric.

![I later braided this long, thin offcut and used it as the coat’s belt.](/img/housecoat/scraps-01.jpeg "I later braided this long, thin offcut and used it as the coat’s belt.")
...
![The patch pocket was the one place where I didn’t mind referencing the original shirt — I like that finished edge at the top.](/img/housecoat/patch-pocket.jpeg "The patch pocket was the one place where I didn’t mind referencing the original shirt — I like that finished edge at the top.")

I was happy with the final fitting.

## Results

![foo](/img/housecoat/tryon-front.jpeg "Fit - front view")
![foo](/img/housecoat/tryon-back.jpeg "Fit - back view")
