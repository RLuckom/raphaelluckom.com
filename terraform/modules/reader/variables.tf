...
locals {
  ...
  friends_table_name = "${var.coordinator_data.system_id.security_scope}-${var.coordinator_data.system_id.subsystem_name}-friends_table-${random_id.table_suffix.b64_url}"
